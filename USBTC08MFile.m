...
%This function was generated by loadlibrary.m parser version 1.1.6.37 on Wed Jun 25 12:15:11 2014
...
fcns.thunkname{fcnNum}='int16int16voidPtrint16int16Thunk';fcns.name{fcnNum}='usb_tc08_get_unit_info2'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int16'; fcns.RHS{fcnNum}={'int16', 'int8Ptr', 'int16', 'int16'};fcnNum=fcnNum+1;
% int16_t usb_tc08_get_formatted_info ( int16_t handle , int8_t * unit_info , int16_t string_length ); 
fcns.thunkname{fcnNum}='int16int16voidPtrint16Thunk';fcns.name{fcnNum}='usb_tc08_get_formatted_info'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int16'; fcns.RHS{fcnNum}={'int16', 'int8Ptr', 'int16'};fcnNum=fcnNum+1;
...
% int16_t usb_tc08_legacy_set_channel ( int16_t handle , int16_t channel , int8_t tc_type , int16_t filter_factor , int16_t offset , int16_t slope ); 
